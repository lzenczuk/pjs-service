 ...
 */
public class ScriptSlotExecutroTest {
    ...
    public void validParams() throws IOException {
        ...
        try {
            ...
            ScriptSlot slot = new ScriptSlot(script, null);

            ScriptSlotExecutor scriptSlotExecutor = new ScriptSlotExecutor();
            SlotValidationResult result = scriptSlotExecutor.validate(slot, Collections.singletonMap("n", 4), "test", scriptExecutor);
